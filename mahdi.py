...
if prompt := st.chat_input("اكتبوا سؤالكم لخبير Massilya الآلي..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("⏳ الخبير يحلل نوع بشرتك..."):
            ...
            - أنت: أهلاً بك. للتخلص من حب الشباب، أنصحك بشدة بالغسول الأسود المقشر (بتركيز 2% BHA) بسعر 950 دج. إنه ممتاز لتنظيف المسام بعمق. هل أرسل لك عبوة؟
            - الزبون: ما هو سعر التوصيل؟
            - أنت: تكلفة التوصيل للعاصمة هي 400 دج، ولباقي الولايات 600 دج. لتأكيد طلبك، يرجى تزويدي بالاسم، الولاية، ورقم الهاتف.
